...
class OpNovicePhysicsList : public G4VUserPhysicsList
{
  ...
  private:
    ...
    static G4ThreadLocal G4PhotoElectricEffect* fPhotoElectricEffect;
    static G4ThreadLocal G4RayleighScattering* fRayleighScattering;
    static G4ThreadLocal G4eMultipleScattering* feMultipleScattering;
    static G4ThreadLocal G4eIonisation* feIonization;             
    static G4ThreadLocal G4eBremsstrahlung* feBremsstrahlung;   
